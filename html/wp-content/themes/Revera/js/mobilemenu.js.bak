(function(a){
	...
	function m(){
		var b=a('<ul id="mmnav" />');c.each(function(){
	...
	function o(c,d){
			...
			n(c,e,b.groupPageText);c.children("ul, ol").each(function(){
	...
	function p(c){
		...
		c.children("li").each(function(){
			var c=a(this);c.children("ul, ol").length&&b.nested?o(c,e):n(c,e)});
		e.change(function(){
			f(a(this).val())}).prependTo(b.prependTo)
	}
	function q(){
		if(i()&&!g())if(b.combine){
			var d=m();p(d)
	...
	var b={combine:!0,groupPageText:"Main",nested:!0,prependTo:"body",switchWidth:767,topOptionText:"Select a page"},c,d=0,e=[];
	a.fn.mobileMenu=function(d){
		d&&a.extend(b,d);
		if(h(a(this))){
			c=a(this);
			q();
			a(window).resize(function(){q()})
